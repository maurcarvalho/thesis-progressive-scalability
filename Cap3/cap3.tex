...
Performance implications are inconsistently evaluated in the literature. Some empirical studies, such as Berry et al.~\cite{berry2024isItWorth} and Blinowski et al.~\cite{blinowski2022monolithic}, compare response times, energy usage, and availability between microservices and monoliths. These works suggest that microservices may perform better at scale but introduce baseline latency due to inter-service communication, a finding consistent with the comparative analysis by Jatkiewicz et al.~\cite{jatkiewicz2023differences}. Modular monoliths, by contrast, are less frequently the subject of direct performance testing, leaving a gap in benchmarking their efficiency in production-grade scenarios.

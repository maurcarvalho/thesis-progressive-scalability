...
The G1--G6 rank ordering returned ties: G1=1, G2=2, G3=3, G5=3, G6=4, G4=4. The ordering should be read as a Likert-style intensity scale rather than as a strict rank, as noted in the limitations discussion of Chapter~5. The G1 top position converges with the qualitative pick of G1 plus G2 as the architectural-dimension priority. The G7--G12 rank ordering also returned ties: G7=2, G8=3, G11=3, G9=4, G10=4, G12=4. The G7 Team-Architecture Balance top position converges with the qualitative emphasis on developer seniority as the structural precondition the framework presupposes (B1, G1-gap).

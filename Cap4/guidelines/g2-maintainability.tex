...
\begin{itemize}[itemsep=8pt,topsep=2pt]
  ...
  \item Detect architectural drift automatically through longitudinal metric tracking before it becomes structurally expensive to reverse.
...
orders:    16 exports  (4 handlers + 4 DTOs + 7 events + 5 listeners)
...
grep -c "new.*Handler" \
  apps/api/src/app/lib/register-listeners.ts
# Was 11, now 12 -> wiring density increased

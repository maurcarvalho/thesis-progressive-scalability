...
G2 extends G1 from boundary correctness to boundary sustainability. While G1 makes dependencies explicit and verifiable, G2 ensures that those dependencies remain limited in scope, stable under evolution, and economically manageable as the system grows~\cite{arya2024beyond,berry2024isItWorth}.
...
\[
  \rho_{\mathrm{api}} \geq 0.95 \land P_{\mathrm{iso}} = 1.0 \land \Gamma \leq 3.0 \land \sigma_m \geq 0.9 \land \phi_m \leq 0.5
\]
...
\begin{enumerate}[itemsep=8pt,topsep=2pt]
  ...
  \item \emph{Longitudinal metric framework.} Six G2-specific metrics operationalize maintainability as bounded cost of change, transforming it from an aspirational property into a measurable, trend-aware constraint.

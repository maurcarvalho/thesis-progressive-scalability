...
% TODO: add BibTeX key for “Just Enough Software Architecture” (model–code gap, architecturally-evident coding style).
% TODO: add BibTeX key for Martin Fowler’s PresentationDomainDataLayering, then integrate it explicitly in the layered architecture discussion.
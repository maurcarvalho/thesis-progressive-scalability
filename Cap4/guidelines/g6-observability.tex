...
G6 is demonstrated through the Tiny Store observability infrastructure~\cite{tinystore2026}, which produces module-scoped logs, metrics, and traces from day one.\footnote{Observability layer at \texttt{libs/shared/infrastructure/src/observability/}.} The tutorial walks through four observability pillars: structured logging, module-scoped metrics, distributed tracing, and alert configuration. Each step is reproducible on any modular monolith with handler-based module boundaries.

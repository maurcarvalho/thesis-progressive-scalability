...
\noindent
Most anti-patterns described here are well known by the software industry. Experienced engineers recognize them on sight during code reviews and design discussions. Yet recognition alone does not prevent them. The gap between conceptual knowledge and daily practice persists because these principles are rarely operationalized as measurable, automated constraints. They exist as shared understanding in the team's collective memory, not as executable checks in the CI pipeline.

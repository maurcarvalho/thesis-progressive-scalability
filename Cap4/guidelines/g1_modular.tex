...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \newline\item \emph{Exercise 1: Create an Encapsulation Leak by Exporting an Internal Symbol:}
...
npm run test:boundary 
  ...
  \newline\item \emph{Exercise 2: Introduce a Direct Cross-Module Import (Undeclared or Forbidden):}

...
\begin{lstlisting}[language=bash,caption={Kamal D2 configuration for orders service ({\ttfamily config/deploy.orders-service.yml}, trimmed)},label={lst:g5-kamal-d1}]

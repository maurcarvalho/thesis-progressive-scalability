...
\begin{itemize}
  ...
  \item April to May 2026: Recruit six to eight expert practitioners and conduct semi-structured interviews focused on G1--G6 and the Tiny Store reference implementation
  \item June 2026: Complete thematic coding of interview transcripts and apply revisions to G1--G6
  \item July 2026: Prepare and distribute optional online survey for broader practitioner feedback
  \item August to September 2026: Finalize G1--G6 and document verification findings
  \item October to December 2026: Begin development of deferred guidelines (G7--G12) based on practitioner feedback and empirical investigation
\end{itemize}

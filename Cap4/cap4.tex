...
A panel of 8--12 experts will be assembled, combining academic and industry perspectives:

\begin{itemize}[noitemsep,topsep=2pt]
  \item 4--5 academic researchers (PhD holders or doctoral candidates in software engineering, software architecture, or distributed systems)
  \item 4--5 industry practitioners (Staff Engineers, Principal Engineers, or Engineering Directors with experience in architectural decisions at scale)
\end{itemize}
